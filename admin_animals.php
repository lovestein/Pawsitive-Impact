            ...
            <div class="col-9 main_content">
                ...
                <div class="container">
                    <div class="jumbotron my-2">
                        <div class="card">
                            <h1 class="text-center my-2">Animals Records</h1>
                        </div>
                        ...
                        <div class="card my-3 p-3">
                            ...
                            ?>
                            <table id="displayAnimalTable" class="table table-hover">
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['animal_breed']; ?></td>
                                            <td><?php echo $row['animal_weight']; ?></td>
                                            <td><?php echo $row['kapon_date']; ?></td>
                                            <td><?php echo $row['arv_date']; ?></td>
                                            <td><?php echo $row['deworm_date']; ?></td>
    ...
    <script>
        $(document).ready(function() {
            $('#displayAnimalTable').DataTable({
                ...
                language:  {
                    search: "_INPUT_",
                    searchPlaceholder: "Search Animal Records"
                }
            });
        });
    </script>
