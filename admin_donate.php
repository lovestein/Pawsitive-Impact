...
<body>
            ...
            <div class="col-9 main_content">
                ...
                <div class="container">
                    <div class="jumbotron my-2">
                        <div class="card">
                            <h1 class="text-center my-2">Donation Records</h1>
                        </div>
                        ...
                        <div class="card my-3 p-3">
                            ...
                            ?>
                            <table id="displayDonationTable" class="table table-hover">
    ...
    <script>
        $(document).ready(function() {
            $('#displayDonationTable').DataTable({
